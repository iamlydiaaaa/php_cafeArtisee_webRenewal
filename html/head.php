...
<div id="visual">
    <div>
        <div class="visual-wrap">
            <div class="v-img1">
                <img src="img/main-visual8.jpg" alt="img1">
            </div>
            <div class="v-img2">
                <img src="img/main-visual9.jpg" alt="img2">
            </div>
            <div class="v-img3">
                <img src="img/main-visual4.jpg" alt="img3">
                <div class="txt">
                    <p>Strawberry Season Special</p>
                    <strong>딸기생크림케이크 한정 판매</strong>
                    <span>예약 주문시 <strong>10% 할인</strong></span>
                    <em>본 이벤트는 재고 사정에 따라 조기 종료될 수 있습니다.</em>
                </div>
            </div>
            <div class="v-img4">
                <img src="img/main-visual6.jpg" alt="img4">
            </div>
        </div>
        <div class="v-btn">
            <p class="btn_next">next</p>
            <p class="btn_prev">prev</p>
        </div>
    </div>
</div>
