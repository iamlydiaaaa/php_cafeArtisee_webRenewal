...
<!-- 게시판 목록 시작 { -->
<div class="sub-desc">
    <h2 class="sub-tit">베이커리</h2>
<!--    <p>아티제가 만든 모든 베이커리는 artisan(장인)이 만든 하나의 작품이며, 엄선된 최고의 재료만을 사용합니다.</p>-->
</div>
<div>  
</div>
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                <figure class="bx-grandi">
                    ...
                    <figcaption>
                        <span class="post-head"><?php echo cut_str($list[$i]['wr_subject'], 100) ?></span>
