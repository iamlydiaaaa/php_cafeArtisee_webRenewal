...
<!-- 게시판 목록 시작 { -->
<h2 class="sub-tit"><strong>새 메뉴</strong></h2>
                        ...
                        if ($is_category && $list[$i]['ca_name']) {
                         ?>
                            ...
                            <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                                <?php echo mb_strimwidth($list[$i]['subject'], '0', '60', '...', 'utf-8'); ?>
...
//                            if (isset($list[$i]['icon_hot'])) echo rtrim($list[$i]['icon_hot']);
                        ...
                        <div class="gall_name">
                            <span class="sound_only">이벤트 설명 </span><span class="profile_img"><?php echo mb_strimwidth($list[$i]['wr_8'], '0', '60', '...', 'utf-8'); ?></span>
                        </div>

                        <div class="gall_name">
                            <span class="sound_only">이벤트 기간 </span><span class="profile_img"><?php echo $list[$i]['wr_9']." ~ ". $list[$i]['wr_10']?></span>
                        </div>
                    </div>
                </div>
            </li>
