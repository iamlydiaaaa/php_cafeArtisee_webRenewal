    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
         ...
         ?>
            ...
            <div id="maps" style="width:100%; height:420px;">
                <!-- * 카카오맵 - 지도퍼가기 -->
                <!-- 1. 지도 노드 -->
                <div id="daumRoughmapContainer1576829925134" class="root_daum_roughmap root_daum_roughmap_landing"></div>
