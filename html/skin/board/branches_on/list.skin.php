    ...
    <div class="cate_map_wrap">
        ...
        <div class="cate_search_wrap">
            ...
            <fieldset id="bo_sch">
                ...
                <form name="fsearch" method="get" class="form-r">
                    <h1>매장 검색</h1>
                    ...
                    <!--<select name="sfl" id="sfl">
                        <option value="wr_subject" <?php echo get_selected($sfl, 'wr_subject', true); ?>>시/도 선택</option>
                        <option value="wr_1" <?php echo get_selected($sfl, 'wr_1'); ?>>서울특별시</option>
                        <option value="wr_1" <?php echo get_selected($sfl, 'wr_1'); ?>>경기도</option>
                        <option value="wr_1" <?php echo get_selected($sfl, 'wr_1'); ?>>인천광역시</option>
                    </select>
                    <select name="sfl" id="sfl">
                        <option value="wr_subject" <?php echo get_selected($sfl, 'wr_subject', true); ?>>시/군/구 선택</option>
                        <option value="wr_1" <?php echo get_selected($sfl, 'wr_1'); ?>>안양시</option>
                    </select>-->
                    <label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
                    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="frm_input required" placehorder="매장명, 주소, 전화번호로 검색" size="50" maxlength="20">
        ...
        for ($i=0; $i<count($list); $i++) {
         ?>
                    <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                        ...
                        <?php } ?>
                        <td class="td_location"><?php echo $list[$i]['ca_name'] ?></td>
                        <td class="td_shop"><?php echo $list[$i]['wr_subject'] ?></td>
                        <td class="td_add"><?php echo $list[$i]['wr_1'] ?></td>
                        <td class="td_tel"><?php echo $list[$i]['wr_2'] ?></td>
                        <td class="td_go"><a href="<?php echo $list[$i]['href'] ?>">자세히보기</a></td>
                    </tr>
                    <?php } ?>
...
<script>
    ...
    $(".cate_map_in svg").mouseover(function(event) {
        ...
        d3.select(_path).style("fill", "#bbe0fb");
