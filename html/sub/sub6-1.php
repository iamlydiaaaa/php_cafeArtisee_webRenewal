...
<div>
    ...
    <div class="form-tit">
        <h2 class="sub-tit"><strong>신규 입점 제의</strong></h2>
        <p>프리미엄 카페 & 베이커리 아티제의 비지니스 파트너를 모집합니다. <br>당사의 모든 매장은 본사에서 직접 운영하는 직영점으로 운영되고 있습니다. <br>따라서 개인이 투자, 운영하실 수 있는 가맹점, 체인점 형태는 불가능함을 알려드립니다.</p>
        <a>상담 신청에 대한 회신은 기재해주신 이메일 또는 유선으로 드립니다. <br>당사 내부 검토에 따라 회신이 지연될 수 있으며,<br>주소 또는 이메일을 잘못 입력할 경우 답변이 불가하므로 반드시 확인바랍니다.
        </a>
    </div>
...
- 시행일자 : 2019년 1월 1일</textarea>
        ...
        <div id="contactForm_form" class="form_01">
            <div class="tbl_frm01 tbl_wrap">
                <ul>
                    <li>
                        <label for="contact_store" class="sound_only">추천점포주소 *</label>
                        <input type="text" class="frm_input email full_input required" id="contact_store" name="contact_store" title="Store" placeholder="추천점포주소">                   
                    <li>
        ...
        <div class="btn_confirm">
            <input id="contact_submit" type="submit" class="btn_submit" value="신청하기">
        </div>
